...
public class GUIBoGaCa extends JFrame implements ActionListener,ItemListener{
...
//            });
	...
	//	JOptionPane.showMessageDialog(null, nguyenlieu);
		...
		{
			for(int i=0;i<cachnau.size();i++)
			{
				model.addElement(nguyenlieu + cachnau.get(i));
			}
		}
	}
	...
	//	JOptionPane.showMessageDialog(null, cachnau);
		if(!cachnau.isEmpty() )
		{
